...
def train_test_Net(model, learning_rate, total_epochs, num_classes, train_loader, test_loader):
    ...
    MSAE_PATH_name = "D:/pyCharm_projects/主要代码/东南轴承齿轮三传感模型验证/轴注意力和自校准编码器分类模型/Mish_SCAEAA_gear30_work{}_" \
                     "epoch{}_lr{}.pt".format(num_classes, total_epochs, learning_rate)
