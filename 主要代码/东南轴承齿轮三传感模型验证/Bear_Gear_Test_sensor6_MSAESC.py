...
if __name__ == '__main__':
    ...
    train_loader_shuffle, test_loader_shuffle, train_loader, test_loader \
        = Bolt4_work4_sensor6_MSDGI_graph_processing.data_processing(path4, batch_size)

    AE_model_path = 'D:/pyCharm_projects/主要代码/六传感全松模型模块作用验证/自编码校正模型/SCAE_sensor6_bolt4_work4_epoch150_lr0.001.pt'
    ...
    MSAE_model_path = 'D:/pyCharm_projects/主要代码/六传感全松模型模块作用验证/自编码校正模型/分类模型/MSSCAE_sensor6_bolt4_work4_epoch150_lr0.0001.pt'
