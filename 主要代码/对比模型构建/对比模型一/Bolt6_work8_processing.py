...
def data_processing(dpath, batch_size):
    ...
    train_data = train_data7  # 384*8*10240
    train_label = lab_train7
    test_data = test_data7  # 112*8*10240
    test_label = lab_test7
