...
def data_processing(path, batch_size):
    ...
    data_CM[9][:] = R1_18[9][:]
    data_CM[10][:] = R1_18[12][:]  # 12NM
    data_CM[11][:] = R1_18[13][:]
    data_CM[12][:] = R1_18[16][:]  # 20NM
    data_CM[13][:] = R1_18[17][:]
    ...
    train_data = train_data6  # 384*8*10240
    train_label = lab_train6
    test_data = test_data6  # 112*8*10240
    test_label = lab_test6
