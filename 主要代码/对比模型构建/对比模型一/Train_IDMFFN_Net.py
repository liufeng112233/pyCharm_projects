...
def train_test_Net(model, learning_rate, total_epochs, num_classes, sensor, train_loader, test_loader):
    # 更新学习率
    ...
    for epoch in range(total_epochs):
        ...
        with torch.no_grad():
            for test_idx, (x_test, label_test) in enumerate(test_loader):
                ...
                x_test1 = x_test.view(8, 1, sensor, 2048)
    ...
    MSAE_PATH_name = "D:/pyCharm_projects/主要代码/对比模型构建/对比模型一/模型二保存/IDMFFN_FB6_work{}_epoch{}_lr{}.pt". \
    ...
    with torch.no_grad():
        for step2, (data2, label2) in enumerate(test_loader):
            ...
            x_data21 = x_data2.view(8, 1, sensor, 2048)
