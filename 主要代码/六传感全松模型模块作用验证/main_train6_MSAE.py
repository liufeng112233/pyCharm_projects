...
if __name__ == '__main__':
    ...
    for epoch in range(Total_Epochs):
        ...
        for step, (data, label) in enumerate(train_loader_shuffle):
            ...
            x_data1 = x_data.view(8, 1, 6, 10240)
        ...
        # 更新优化参数的学习率
        if (epoch + 1) % 50 == 0:  # each 20 epoch, decay the learning rate
            curr_lr /= 2
    ...
    with torch.no_grad():
        ...
        for step1, (data1, label1) in enumerate(test_loader_shuffle):
            ...
            input_data = input_data1.view(8, 1, 6, 10240)
    ...
    PATH_name = "D:/pyCharm_projects/主要代码/六传感全松模型模块作用验证/自编码器模型/MSAE_Bolt1_sensor6_work{}_epoch{}_lr{}.pt".format(num_classes,
                                                                                                     Total_Epochs,
                                                                                                     learning_rate)
