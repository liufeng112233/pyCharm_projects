...
class Multi_features(nn.Module):
    def __init__(self, in_channels, out_channels, Activate_fun, sensor):
        """
        ...
        # 第一层卷积
        self.features1 = nn.Conv2d(in_channels=in_channels, out_channels=out_channels, kernel_size=(sensor, 16),
                                   stride=(1, 16), padding=(0, 0))
        self.features2 = nn.Conv2d(in_channels=in_channels, out_channels=out_channels, kernel_size=(sensor, 32),
                                   stride=(1, 16), padding=(0, 8))
        self.features3 = nn.Conv2d(in_channels=in_channels, out_channels=out_channels, kernel_size=(sensor, 64),
                                   stride=(1, 16), padding=(0, 24))
        self.features4 = nn.Conv2d(in_channels=in_channels, out_channels=out_channels, kernel_size=(sensor, 128),
...
class Attention_Fusion_Net(nn.Module):
    def __init__(self, sc_ae_model, in_channel, out_channel, Activate_fun, sensors, ration=1):
        """
        ...
        self.M_Conv_layer = Multi_features(in_channel, out_channel, Activate_fun, sensors)  # 获取多尺度的聚合特征
        # 特征矩阵聚拢
