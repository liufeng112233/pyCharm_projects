...
def train_test_Net(model, learning_rate, total_epochs, num_classes, sensor, train_sample, train_loader, test_loader):
    # 更新学习率
    ...
    MSAE_PATH_name = "D:/pyCharm_projects/主要代码/六传感全松模型模块作用验证/对比模型/IDMFFN/bolt1_train{}_work{}_epoch{}_lr{}.pt". \
