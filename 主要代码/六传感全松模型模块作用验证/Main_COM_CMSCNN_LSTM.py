...
from Train_CMSCNN_LSTM_Net import train_test_Net
# CWRU data
...
if __name__ == '__main__':
    ...
    MSCNN_DF_model = CMSCNN_LSTM(num_classes=num_classes, sensor=sensor_num).to(devices)
    train_epochs_avgloss, test_epochs_avgloss, test_accuracy,out_feature, out_label = \
        train_test_Net(MSCNN_DF_model,
                       learning_rate,
                       Total_Epochs,
                       num_classes,
                       train_sample_number,
