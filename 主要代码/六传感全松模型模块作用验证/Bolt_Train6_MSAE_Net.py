...
def train_test_Net(model, learning_rate, total_epochs, num_classes, train_loader, test_loader):
    ...
    for epoch in range(total_epochs):
        ...
        with torch.no_grad():
            ...
            # 验证集平均损失D:\pyCharm_projects\主要代码\六传感全松模型模块作用验证\自编码器模型\自编码器模型
    ...
    # 模型一保存
    MSAE_PATH_name = "D:/pyCharm_projects/主要代码/六传感全松模型模块作用验证/自编码校正模型/分类模型/SC0_AE_Bolt_sensor6_work{}_epoch{}_lr{}.pt". \
