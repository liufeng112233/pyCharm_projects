...
def train_test_Net(model, learning_rate, total_epochs, num_classes, batch_size, train_sample,train_loader, test_loader):
    # 更新学习率
    ...
    for epoch in range(total_epochs):
        ...
        for step, (x, label) in enumerate(train_loader):
            ...
            x1 = x.view(batch_size, 1, 6, 10240)
        ...
        # curr_lr = learning_rate*0.90**epoch
    ...
    MSAE_PATH_name = "D:/pyCharm_projects/主要代码/DIRG轴承六传感模型验证/小样本模型/分类模型/SCAEAA_DIRG_S500_L000_{}_work{}_" \
                     "epoch{}_lr{}.pt".format(train_sample, num_classes, total_epochs, learning_rate)
    ...
    with torch.no_grad():
        for step2, (data2, label2) in enumerate(test_loader):
            ...
            x_data21 = x_data2.view(batch_size, 1, 6, 10240)
