...
def data_processing(path, batch_size):
    ...
    data_work2 = np.vstack(data_resample(data[10, :], data[11, :], data_len, data_step)).reshape(126, 1, 10240)  # 10NM
    data_work3 = np.vstack(data_resample(data[16, :], data[17, :], data_len, data_step)).reshape(126, 1, 10240)  # 20NM
    ...
    train_data = train_data2  # 288*1*10240
    train_label = lab_train2
    test_data = test_data2  # 96*8*10240
    test_label = lab_test2
