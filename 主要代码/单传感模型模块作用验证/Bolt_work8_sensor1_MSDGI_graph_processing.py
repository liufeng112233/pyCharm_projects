...
def data_processing(path, batch_size):
    ...
    data_work8 = np.vstack(data_resample(data[16, :], data[17, :], data_len, data_step)).reshape(126, 1, 10240)  # 20NM
    ...
    train_data = train_data7  # (96*num)*1*10240
    train_label = lab_train7
    test_data = test_data7  # (32*num)*1*10240
