...
if __name__ == '__main__':
    ...
    PATH_name = "D:/pyCharm_projects/主要代码/单传感模型模块作用验证/预训练模型/SCAE_heng_channel{}_work{}_epoch{}_lr{}.pt". \
        format(sensor_order, num_classes, Total_Epochs, learning_rate)
    ...
    for epoch in range(Total_Epochs):
        ...
        for step, (data, label) in enumerate(train_loader_shuffle):
            ...
            x_data1 = x_data.view(8, 1, 1, 10240)
    ...
    with torch.no_grad():
        ...
        for step1, (data1, label1) in enumerate(test_loader_shuffle):
            ...
            input_data = input_data1.view(8, 1, 1, 10240)
