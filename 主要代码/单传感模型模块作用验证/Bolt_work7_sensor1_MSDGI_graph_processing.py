...
def data_processing(path, batch_size):
    ...
    data_work6 = np.vstack(data_resample(data[12, :], data[13, :], data_len, data_step)).reshape(126, 1, 10240)  # 12NM
    data_work7 = np.vstack(data_resample(data[16, :], data[17, :], data_len, data_step)).reshape(126, 1, 10240)  # 20NM
    ...
    train_data = train_data6  # (96*num)*1*10240
    train_label = lab_train6
    test_data = test_data6  # (32*num)*1*10240
