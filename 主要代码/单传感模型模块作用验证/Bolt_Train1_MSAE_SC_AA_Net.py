...
def train_test_Net(model, learning_rate, total_epochs, num_classes, sensor_oredr, train_loader, test_loader, sensor_num=1):
    # 更新学习率
    ...
    for epoch in range(total_epochs):
        ...
        for step, (x, label) in enumerate(train_loader):
            ...
            x1 = x.view(8, 1, sensor_num, 10240)
    ...
    MSAE_PATH_name = "D:/pyCharm_projects/主要代码/单传感模型模块作用验证/预训练模型/分类模型/SCAEAA_heng_channel{}_" \
                     "work{}_epoch{}_lr{}.pt".format(sensor_oredr, num_classes, total_epochs, learning_rate)
