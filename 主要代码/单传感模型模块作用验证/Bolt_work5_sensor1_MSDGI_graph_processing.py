...
def data_processing(path, batch_size, sensors_order):
    ...
    data_work2 = np.vstack(data_resample(data[4, :], data[5, :], data_len, data_step)).reshape(126, 1, 10240)  # 7NM
    data_work3 = np.vstack(data_resample(data[8, :], data[9, :], data_len, data_step)).reshape(126, 1, 10240)  # 9NM
    data_work4 = np.vstack(data_resample(data[12, :], data[13, :], data_len, data_step)).reshape(126, 1, 10240)  # 12NM
    data_work5 = np.vstack(data_resample(data[16, :], data[17, :], data_len, data_step)).reshape(126, 1, 10240)  # 20NM
