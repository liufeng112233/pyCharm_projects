...
class Multi_features(nn.Module):
    def __init__(self, in_channels, out_channels, sensor):
        ...
        self.layer_fusion1 = nn.Conv2d(in_channels=out_channels, out_channels=out_channels, kernel_size=(sensor, 1),
                                       stride=(1, 1))
        self.fc = nn.ReLU()
...
class MySC_AE(nn.Module):
    ...
    def forward(self, x):
        ...
        de_x5 = de_x5.view(de_x5.size()[0], de_x5.size()[1]*de_x5.size()[2]*de_x5.size()[3])
        de_x6 = self.de_layer31(de_x5)

        de_x7 = de_x6.view(8, 1, 10240)
